...
def load_file_to_dbfs(local_file_path, api_client):
    ...
    dbfs.delete(file_path.join("autoload_file_to_delta_3.py"), recursive=False)
    dbfs.put_file(
        src_path=str(local_file_path), dbfs_path=file_path.join("autoload_file_to_delta_3.py"), overwrite=True
    )
...
def create_job(
    ...
    json_info = {
        ...
        "spark_python_task": {"python_file": "dbfs:/mnt/pyscripts/autoload_file_to_delta_3.py"},
    }
