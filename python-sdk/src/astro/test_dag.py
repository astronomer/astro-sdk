...
def _parse_arguments(conn_file_path, variable_file_path):
    """

    :param conn_file_path:
    :param variable_file_path:
    :return:
    """
    parser = argparse.ArgumentParser()
    parser.add_argument(
        dest="conn_file", help="This is the first argument", default=None
    )
    parser.add_argument(
        dest="variable_file", help="This is the first argument", default=None
    )
    args = parser.parse_args()
    conn_file_path = conn_file_path or args.conn_file
    variable_file_path = variable_file_path or args.variable_file
    return conn_file_path, variable_file_path
...
def test_dag(
    ...
    conn_file_path, variable_file_path = _parse_arguments(
        conn_file_path, variable_file_path
    )
