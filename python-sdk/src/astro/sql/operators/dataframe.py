...
class DataframeOperator(AstroSQLBaseOperator, DecoratedOperator):
    ...
    def execute(self, context: Context) -> BaseTable | pd.DataFrame | list:
        ...
        if isinstance(function_output, (list, tuple)):
            ...
            function_output = {k :convert_columns_names_capitalization(df=v, columns_names_capitalization=self.columns_names_capitalization) for k,v  in function_output.items()}
